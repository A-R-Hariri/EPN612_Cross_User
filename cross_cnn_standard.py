...
# NAME = "cnn_standard_grl"
# model = CNN_GRL()
# print(model, f"\nParameters count: {count_params(model):,}")
# train_grl(model=model, name=NAME, 
#       train_loader=train_loader_standard_sbj,
#       val_loader=val_loader_standard, 
#       loss_fn=nn.CrossEntropyLoss(weight=weights),
...
NAME = "cnn_standard_sbj"
model = CNN()
print(model, f"\nParameters count: {count_params(model):,}")
train_sbj(model=model, name=NAME, 
      train_loader=train_loader_standard_sbj,
      val_loader=val_loader_standard_sbj, 
